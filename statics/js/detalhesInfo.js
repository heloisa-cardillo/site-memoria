...
`,
  ...
  'suelena': {
    ...
    conteudo: `
    <img src="../statics/imgs/pessoas/suelena/suelenaImagem.jpeg" alt="Professora Maria Suelena Santiago" class="card-image" style="object-fit: cover; object-position: center;">    <p>Formada em <strong>Engenharia Mecânica pela Escola Federal de Engenharia de Itajubá (EFEI)</strong> em 1969, concluiu também <strong>graduação em Matemática</strong> e, mais tarde, em <strong>Ciências Biológicas pela Universidade do Vale do Paraíba (2000)</strong>. Ingressou no <strong>Instituto Nacional de Pesquisas Espaciais (INPE)</strong> — ainda conhecido como CNAE — logo após a graduação, onde fez <strong>mestrado em Análise de Sistemas e Aplicações (1973)</strong> e <strong>doutorado em Computação Aplicada (1986)</strong>. O período no INPE foi de grande aprendizado e inspiração, especialmente sob a direção de pesquisadores que marcaram sua formação científica e pessoal.</p>
